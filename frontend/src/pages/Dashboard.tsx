...
const Dashboard: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (!tenantId) {
      setPlanError('No tenant ID found.');
  ...
  return (
    <div style={{ maxWidth: 1100, margin: '3rem auto', padding: '2rem 1rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div className="card">
        ...
        <ul style={{ textAlign: 'left', maxWidth: 600, margin: '1rem auto', fontSize:'1.08rem', lineHeight:1.7 }}>
          <li><a href="/docs/event-model.md" target="_blank" rel="noopener noreferrer" style={{ color: '#4f46e5', textDecoration: 'underline' }}>Event Model Documentation</a></li>
          <li><a href="mailto:damoladauda10@gmail.com" style={{ color: '#4f46e5', textDecoration: 'underline' }}>Contact Support (Email)</a></li>
          <li>
            <a href="https://discord.com/users/your-discord-id" target="_blank" rel="noopener noreferrer" style={{ color: '#5865F2', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
          ...
          <li><a href="/docs" target="_blank" rel="noopener noreferrer" style={{ color: '#4f46e5', textDecoration: 'underline' }}>Full Documentation</a></li>
          <li><a href="/faq" style={{ color: '#4f46e5', textDecoration: 'underline' }}>FAQ</a></li>
        </ul>
      </div>
    </div>
  );
